...
-- The project_files table contains file data directly, not references to a separate files table
-- This version uses audio_tracks table for track counting instead of project_files
...
BEGIN
  ...
  -- Calculate stats - count audio_tracks directly by user_id
