-- Fix get_profile_with_stats function to properly count tracks
-- The function was incorrectly trying to join project_files with files,
-- but should count audio_tracks directly since that table has user_id
