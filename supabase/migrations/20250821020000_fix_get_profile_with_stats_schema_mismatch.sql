-- Fix get_profile_with_stats function to match actual profiles table schema
-- Remove references to non-existent fields: professional_title, website_url, social_links, banner_url, bio
