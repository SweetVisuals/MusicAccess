...
import { Search, Star, MessageSquare, Heart, Briefcase, Clock, DollarSign, Filter, ChevronDown } from "lucide-react"
import {
  Collapsible,
  CollapsibleContent,
  CollapsibleTrigger,
                      ...
                      <Card className="flex flex-col">
                          ...
                          <div className="flex items-center gap-4 mb-4">
                            ...
                            <div>
                              ...
                              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                ...
                                <span>•</span>
                                <div>{service.provider.reviews}</div>
                              </div>
                            </div>
                          </div>
                        ...
                        <CollapsibleContent>
                          <div className="p-6 pt-0 text-sm text-muted-foreground">
                            ...
                            More details about {service.title} will go here.
                          </div>
                        </CollapsibleContent>
