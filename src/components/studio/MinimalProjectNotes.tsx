...
interface MinimalProjectNotesProps {
...
export function MinimalProjectNotes({ 
  project, 
  onNoteCreated, 
  onNoteUpdated, 
  onNoteDeleted 
}: MinimalProjectNotesProps) {
  const { user } = useAuth()
    ...
    return (
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="text-center text-muted-foreground">
          ...
          <p className="text-xs">Select a project to view notes</p>
        </div>
      </div>
    )
  }
          ...
          <Card className="animate-slide-up">
            ...
            <CardContent className="px-3 pb-3 space-y-2">
              ...
              <textarea
                ...
                className="w-full min-h-[60px] p-2 border rounded-md text-xs resize-none"
              />
              ...
              <CardContent className="px-3 pb-3">
                {editingNoteId === note.id ? (
                  <textarea
                    ...
                    className="w-full min-h-[40px] p-2 border rounded-md text-xs resize-none"
                  />
                ) : (
                  <p 
